...
int  find(vector<int>,vector<int>,vector<int>,vector<int>);
void shift(vector<int> ,vector<int>,vector<int>,vector<int>);
int  szOf(vector<int> ,vector<int>,vector<int>);
int  delVal(vector<int> ,vector<int>,vector<int>,vector<int>);
int  replce(vector<int> ,vector<int>,vector<int>,vector<int>);
