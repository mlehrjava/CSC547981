...
int main(int argc, char *argv[])
{
    ...
    //Create Copied array with memory
    int *copy;
    copy=new int[sizeOf];
    
    //Copy array and resize the copied array to remove -1s
    reSize(array,copy,sizeOf);
    
    //Print the copied array
    prntAry(copy,sizeOf,10);
...
void reSize(int a[],int b[],int sOf){
     for(int i=0;i<sOf;i++){
         b[i]=a[i];
     }
