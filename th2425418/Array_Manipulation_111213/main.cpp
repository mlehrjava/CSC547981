...
int main(int argc, char *argv[]){
    ...
    << sizeOf << endl;
    sizeOf=delVal(array,SIZE,60,-1);
    cout<< "Size of the Array = "
    << sizeOf << endl;
    cout << endl;
    //Find and Change
    int chgOf=chgVal(array,SIZE,25,30);
    //Print the Array
    prntAry(array,SIZE,10);
...
int chgVal(int a[],int n,int value,int vInsrt){
    //Find and change
    int posFnd = 0;
...
//Randomly fill an Array with 2 digit numbers
